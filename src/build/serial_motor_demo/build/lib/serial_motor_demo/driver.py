...
class MotorDriver(Node):
    ...
    def check_encoders(self):
        ...
        if (resp):
            ...
            # Handle the case when the response is empty (serial communication timeout)
            print("Error: Serial communication timeout while reading encoder values")
            return
    ...
    def send_command(self, cmd_string):
        ...
        try:
            ...
            self.get_logger().warn(str(e))  # Log the warning
            return ''
        finally:
            self.mutex.release()
